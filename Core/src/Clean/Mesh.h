...
namespace Clean
{
    ...
    **/
    struct SubMesh
    {
        ...
        //! @brief Default material proposed for this SubMesh. 
     ...
     *
     * Material Management
     * For each submesh, a different material may be proposed when loading the mesh file. Those materials can be retrieved
     * with findMaterial(submesh). Notes that populateRenderCommand() does not bind the submesh material for you. You have
     * to call EffectSession::addMaterial() with your material in your RenderCommand or RenderSubCommand to bind your material
     * onto the command/subcommand.
     *
    **/
    class Mesh final : public Handled < Mesh >
    {
        ...
        //! @brief Original file this mesh is from. Empty if not created from a file. 
        Property < std::string > origin;
    ...
    public:
        ...
        **/
        ...
        //! @brief Callback for populateRenderCommand.
        using PopulateCallback = std::function < void(RenderSubCommand&, SubMesh const&) >;
         ...
         *
         * \param[in] driver A Driver already associated to this Mesh. 
         * \param[in] command The RenderCommand we want to fill with this Mesh RenderSubCommands.
         *
        **/
        ...
        **/
        ...
        /*! @brief Sets the file path associated to this mesh. */
